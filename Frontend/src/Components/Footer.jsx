          ...
          <div>
            ...
            <form className="space-y-3">
                ...
                <button className="relative group w-full">
                    <div className="relative w-full py-3 bg-emerald-500 hover:bg-emerald-600 rounded-md flex items-center justify-center font-bold text-white text-sm transition-all duration-200">
                        Subscribe
                    </div>
                </button>
            </form>
