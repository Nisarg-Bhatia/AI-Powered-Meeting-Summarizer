    ...
    return (
        <div className="min-h-screen bg-[#1a1a1a] text-white flex overflow-hidden">
            ...
            <button
                ...
                className="lg:hidden fixed top-6 left-4 z-50 p-2 bg-[#262626] border border-gray-700 rounded-md text-white hover:border-emerald-500/50 transition-all"
            >
                <MenuIcon />
            </button>
            ...
            {/* Sidebar */}
            <aside className={`w-64 bg-[#262626] border-r border-gray-700 flex flex-col fixed h-full z-50 transition-transform duration-300 ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'
                }`}>
                ...
                <div className="p-6 border-b border-gray-700 flex justify-between items-center">
                    ...
                    <button
                        onClick={() => setIsMobileMenuOpen(false)}
                        className="lg:hidden p-2 hover:bg-[#1a1a1a] rounded-md transition-all text-gray-400 hover:text-white"
                    >
                        <CloseIcon />
                    </button>
                </div>
                ...
                <div className="p-4 border-t border-gray-700">
                    <div
                        ...
                        className={`flex items-center space-x-3 p-3 rounded-md border transition-all cursor-pointer group ${activeNav === 'profile'
                            ? 'bg-emerald-500/10 border-emerald-500/50'
                            : 'bg-[#1a1a1a] border-gray-700 hover:border-emerald-500/50'
                            }`}
                    >
            ...
            <main className="flex-1 lg:ml-64 overflow-y-auto">
                ...
                {activeNav === 'profile' && <ProfileContent />}
            </main>
        </div>
    )
}
    ...
    return (
        <>
            ...
            <header className="bg-[#262626]/50 backdrop-blur-sm border-b border-gray-700 sticky top-0 z-40">
                <div className="px-8 py-6 pl-16 lg:pl-8">
                    <div className="flex justify-between items-center">
                        ...
                        <button className="px-6 py-3 bg-emerald-500 hover:bg-emerald-600 text-white font-semibold rounded-md transition-all duration-300">
                            Save Changes
                        </button>
                    </div>
                </div>
            ...
            <div className="p-8 space-y-8">
                ...
                <div className="group relative">
                    ...
                    <div className="relative bg-[#262626] border border-gray-700 rounded-md p-6 hover:border-emerald-500/50 transition-all">
                        ...
                        <div className="flex items-start justify-between mb-6">
                            <div className="w-24 h-24 rounded-full bg-gradient-to-br from-emerald-500 to-emerald-600 flex items-center justify-center font-bold text-white text-3xl">
                                JD
                            </div>
                            <button className="px-4 py-2 bg-emerald-500/10 hover:bg-emerald-500/20 border border-emerald-500/50 text-emerald-400 font-semibold rounded-md transition-all">
                                Change Avatar
                            </button>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 bg-[#1a1a1a] border border-gray-700 rounded-md text-white focus:border-emerald-500 focus:outline-none transition-all"
                                />
                            </div>
                            <div>
                ...
                {/* Danger Zone */}
                <div className="group relative">
                    <div className="absolute -inset-0.5 bg-gradient-to-r from-red-500/20 to-red-600/20 rounded-md blur opacity-20 group-hover:opacity-40 transition duration-500"></div>
                    <div className="relative bg-[#262626] border border-gray-700 rounded-md p-6 hover:border-red-500/50 transition-all">
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center justify-between p-4 bg-[#1a1a1a] rounded-md border border-gray-700">
                                ...
                                <button className="px-4 py-2 bg-gray-700 hover:bg-gray-600 text-white font-semibold rounded-md transition-all">
                                    Change
                                </button>
                            </div>

                            <div className="flex items-center justify-between p-4 bg-[#1a1a1a] rounded-md border border-red-900/50">
                                <div>
                                ...
                                <button
                                    ...
                                    disabled={isDeleting}
                                    className="px-4 py-2 bg-red-500/10 hover:bg-red-500/20 border border-red-500/50 text-red-400 font-semibold rounded-md transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
